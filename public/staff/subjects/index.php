  ...
  <div class="subjects listing">
    ...
    <table class="list">
      ...
      <tr>
        ...
        <td><a class="action" href="<?php echo url_for('staff/subjects/show.php?id=' . h(u($subject['id'])))?>">View</a>
        </td>
        <td><a class="action" href="<?php echo url_for('staff/subjects/edit.php?id=' . h(u($subject['id'])))?>">Edit</a>
        </td>
